...
{boolean: {$regex: search, $options: 'i'}},
...
boolean: t.find('#boolean').value,
number: t.find('#number').value? Number(t.find('#number').value):null,
discription: t.find('#discription').value,
